...
@section('title', "Sub-categories - 404")
...
<div class="container text-center my-4 p-5">
    <div class="row">
        ...
        <div class="container mt-lg-4 d-flex justify-content-center text-center w-100">
            <span class="alert alert-danger p-2 rounded text-dark h2">Sorry! The sub-category that you are searching for is not found.</span>
        </div>
    </div>
</div>
@endsection
